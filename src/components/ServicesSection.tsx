  ...
  const services = [
    {
      ...
      description:
        "Custom web applications built with the latest technologies for optimal performance and user experience.",
      features: [
        "React & Next.js",
        "Responsive Design",
        "SEO Optimized",
    ...
    },
    {
      ...
      description:
        "Intelligent automation and machine learning solutions to enhance productivity and decision-making.",
      features: [
        "Machine Learning",
        "Data Analytics",
        "Process Automation",
    ...
    },
    {
      ...
      description:
        "Strategic consulting to help you navigate digital transformation and achieve business goals.",
      features: [
        "Growth Strategy",
        "Tech Consulting",
        "Digital Roadmap",
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              From concept to deployment, we offer end-to-end technology
              services that transform ideas into powerful digital experiences.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {services.map((service, index) => (
              <Card
                key={index}
                className="glass p-8 hover-glow transition-all duration-300 group"
              >
                <div className="mb-6">
          ...
          <div className="text-center">
            <Card className="glass p-12 max-w-4xl mx-auto">
              ...
              <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                ...
                business forward and help you achieve your digital goals.
              </p>
              <Button
                size="lg"
                onClick={scrollToContact}
                className="bg-gradient-to-r from-primary to-accent hover:shadow-glow hover:scale-105 transition-all duration-300 text-sm sm:text-lg px-4 py-3 sm:px-6 sm:py-2 w-full sm:w-auto mx-auto"
              >
                Get Started Today
